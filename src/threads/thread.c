...
/*-------------------------------------cambios------------------------------------------------*/
/* viajar por la lista reducir e tiempo para despertar y despertar si llega a -1*/ 
struct list_elem *e;
...
thread_unblock (struct thread *t) 
{
  ...
  /*----------------------------------------------cambios--------------------------------------*/
if(!intr_context()){
struct thread *nao = thread_current();

if (nao->priority < t->priority){
		thread_yield();
}
}	
